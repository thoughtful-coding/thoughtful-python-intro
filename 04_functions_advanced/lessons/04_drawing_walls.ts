      ...
      content: [
        {
          kind: "text",
          value:
            "We have provided two helper functions: `draw_small_brick()` (width 25) and `draw_big_brick()` (width 50). Both are 20 pixels tall. Both functions leave the turtle at the bottom-right corner of the brick, ready to draw the next brick immediately.\n\nWrite a script that draws one small brick, then draws one big brick right next to it. Since the brick functions leave the turtle in the right position, you shouldn't need to move the turtle between bricks.",
        },
      ],
      example: {
      ...
      content: [
        {
          kind: "text",
          value:
            "We need two types of rows to make the Running Bond pattern work. Match the Row Name to the correct brick pattern.",
        },
      ],
      prompts: [
        { "Row A": "Big, Big, Big, Small (ends with half brick)" },
        { "Row B": "Small, Big, Big, Big (starts with half brick)" },
        { Wall: "Stack of alternating rows: A, B, A..." },
      ],
      feedback: {
        correct:
      ...
      content: [
        {
          kind: "text",
          value:
            "Define `draw_row_a()`. It should draw **3 Big Bricks** followed by **1 Small Brick**. The total width will be 175 pixels (50 + 50 + 50 + 25).\n\nSince we don't have loops yet, just call the brick functions one after another. Remember: each brick function leaves the turtle ready for the next brick.",
        },
      ],
      example: {
        visualization: "turtle",
      ...
      content: [
        {
          kind: "text",
          value:
            "Now define `draw_row_b()`. It should start with **1 Small Brick**, followed by **3 Big Bricks**. This row is also 175 pixels wide (25 + 50 + 50 + 50).",
        },
      ],
      example: {
        visualization: "turtle",
      ...
      content: [
        {
          kind: "text",
          value:
            "Suppose you decide the wall looks too short. You want to make the bricks taller (30 pixels instead of 20 pixels). Where in the code do you need to make changes?",
        },
      ],
      options: [
        "In `draw_wall` (because it draws the wall)",
        "In `draw_row_a` and `draw_row_b` (because they draw lines of bricks)",
        "In `draw_small_brick` and `draw_big_brick` (because they define the brick shape)",
